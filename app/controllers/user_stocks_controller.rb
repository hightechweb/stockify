class UserStocksController < ApplicationController
    ...
    respond_to do |format|
      if @user_stock.save
        format.html { redirect_to my_portfolio_path,
          notice: "#{@user_stock.stock.ticker} stock was successfully added to your portfolio!" }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to my_portfolio_path,
        notice: "#{@user_stock.stock.ticker} stock was successfully removed from your portfolio!" }
